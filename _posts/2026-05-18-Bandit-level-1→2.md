...
이번 문제는 홈 디렉터리에 있는 `-` 라는 파일에 비밀번호가 저장되어 있고, `bandit2`에 로그인 하는 것이 목표다.

## 풀이 과정

<img width="440" height="150" alt="image" src="https://github.com/user-attachments/assets/b78d7fb7-20aa-4cee-9766-9069b452df22" />
